...
import { DialogPhonelogsComponent } from './dialog-phonelogs/dialog-phonelogs.component';
...
@Component({
  ...
  styleUrl: './page-phone.component.css',
  providers: [DialogService, ConfirmationService, MessageService],
})
export class PagePhoneComponent implements OnInit {
  ...
  showDialog(transaction?: Transaction): void {
    this.ref = this.dialogService.open(DialogPhoneComponent, {
      data: transaction ?? null,
      header: transaction ? 'Edit Phone Transaction' : 'Add Phone Transaction',
      modal: true,
      width: '40vw',
  ...
  showLogsDialog(transaction: Transaction): void {
    this.ref = this.dialogService.open(DialogPhonelogsComponent, {
      data: transaction ?? null,
